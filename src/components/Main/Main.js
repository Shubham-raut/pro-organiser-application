...
class Main extends Component {
    ...
    componentDidMount(){
        ...
        axios.get(`https://pro-organizer-app-376ab.firebaseio.com/Boards.json`)
        .then(TheData=>{
        ...
        axios.get(`https://pro-organizer-app-376ab.firebaseio.com/${this.props.match.params.id}/Columns.json`)
        .then(columnName=>{           
